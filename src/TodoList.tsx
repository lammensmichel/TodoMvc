...
export default class TodoList extends React.Component <TodoListProps, TodoListState> {
  ...
  render () {
    ...
    <footer className="footer" >
      ...
      <ul className="filters">
        <li>
          <a href="#/" className={cx({ selected: filter === 'all' })} onClick={this.seFtilter('all')} >All</a>
        </li>
        <li>
          <a href="#/active" className={cx({ selected: filter === 'active' })} onClick={this.seFtilter('active')} >Active</a>
        </li>
        <li>
          <a href="#/completed" className={cx({ selected: filter === 'completed' })} onClick={this.seFtilter('completed')} >Completed</a>
        </li>
      </ul>
  ...
  seFtilter = (filter: FilterOptions) => {
